...
def link_record_against_mpi(
    ...
    :param external_person_id: An optional string identifier assigned to
      the incoming patient that has been generated by an external system.
      Defaults to None.
    :param external_source_name: An optional string indicating the name
      of the external system that generated the external ID supplied with
      the incoming record. Defaults to None. Must be supplied if calling
      the function with an `external_person_id`.
    ...
    # External information must be either both provided or both None
