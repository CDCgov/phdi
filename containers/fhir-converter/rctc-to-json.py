...
def convert_rctc_to_json(input_file, output_file_grouping, output_file_expansion):
    ...
    Parameters:
        input_file: Path to the input Excel file containing RCTC data.
        output_file_grouping: Path for the output JSON file with grouping data.
        output_file_expansion: Path for the output JSON file with expansion
                               data.
    """
