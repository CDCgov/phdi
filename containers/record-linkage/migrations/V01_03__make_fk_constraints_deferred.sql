...
ALTER TABLE name ADD CONSTRAINT IF NOT EXISTS fk_name_to_patient 
...
ALTER TABLE identifier ADD CONSTRAINT IF NOT EXISTS fk_ident_to_patient 
FOREIGN KEY (patient_id)
REFERENCES patient(patient_id)
DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE phone_number ADD CONSTRAINT IF NOT EXISTS fk_phone_to_patient 
FOREIGN KEY (patient_id)
REFERENCES patient(patient_id)
DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE address ADD CONSTRAINT IF NOT EXISTS fk_addr_to_patient 
FOREIGN KEY (patient_id)
REFERENCES patient(patient_id)
DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE given_name ADD CONSTRAINT IF NOT EXISTS fk_given_to_name 
FOREIGN KEY (name_id)
...
ALTER TABLE external_person ADD CONSTRAINT IF NOT EXISTS fk_ext_person_to_person 
...
ALTER TABLE external_person ADD CONSTRAINT IF NOT EXISTS fk_ext_person_to_source 
