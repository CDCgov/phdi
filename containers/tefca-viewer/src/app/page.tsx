    ...
    <div className="display-flex flex-justify-center flex-column">
        ...
        <div className="container">
          <div className="text-holder">
            ...
            <h2 className="font-sans-md text-light margin-top-2">
              The TEFCA Query Connector allows your jurisdiction to query a wide
              network of healthcare organizations (HCOs) enabled by TEFCA,
      ...
      <div className="home">
        ...
        <h2 className="font-sans-md text-light margin-top-0">
          The TEFCA Query Connector aims to streamline the collection of health
          data using an intuitive querying process that leverages Qualified
          Health Information Networks (QHINs) within the Trusted Exchange
        ...
        <h2 className="font-sans-md text-light margin-top-0">
          ...
          birth, or medical identifiers — along with a query use case, into the
          TEFCA Viewer. The TEFCA Viewer surfaces patient data relevant to the
