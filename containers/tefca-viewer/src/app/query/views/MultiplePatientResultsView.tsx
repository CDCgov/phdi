...
/**
 * The props for the MultiplePatientResultsView component.
 */
export interface MultiplePatientResultsView {
  patients: Patient[];
 ...
 * @param root0 - MultiplePatientResultsView props.
 ...
 * @returns - The MultiplePatientResultsView component.
 */
const MultiplePatientResultsView: React.FC<MultiplePatientResultsView> = ({
  patients,
  originalRequest,
  setLoading,
  goBack,
...
export default MultiplePatientResultsView;
