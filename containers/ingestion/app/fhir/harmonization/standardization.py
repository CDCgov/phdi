...
def _standardize_names_in_resource(
    ...
    * Patient
    ...
    `app.harmonization`. For more information, see the docstring for
    that function.
...
def standardize_dob(data: dict, format: str = "%Y-%m-%d", overwrite=True) -> dict:
    ...
    `app.harmonization`.  The final birthDate will follow the FHIR STu3/R4 format
