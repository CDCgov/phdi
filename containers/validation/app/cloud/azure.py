...
class AzureCredentialManager(BaseCredentialManager):
    ...
    def resource_location(self) -> str:
        """
        Gets the the URL or other location of the requested resource.
        """
    ...
    def scope(self) -> str:
        """
        Gets a space-delimited list of scopes to limit access to resource.
        """
        return self.__scope
...
class AzureCloudContainerConnection(BaseCloudStorageConnection):
    ...
    def storage_account_url(self) -> str:
        """
        Get the storage account location of the requested resource.
        """
    ...
    def cred_manager(self) -> AzureCredentialManager:
        """
        Get the credential manager used to authenticate to the FHIR server.
        """
