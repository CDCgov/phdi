...
describe("Demographics", () => {
    ...
    beforeAll(() => {
        const fhirPathFile = fs.readFileSync('./src/app/api/fhir-data/fhirPath.yml', 'utf8').toString();
        ...
        container = render(<Demographics fhirPathMappings={fhirPathMappings} fhirBundle={fhirBundle} />).container;
    })
