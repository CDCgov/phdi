...
def test_geocode_resource():
    ...
    assert census_client.geocode_client is not None
    ...
    census_client.geocode_client.geocode_from_str = mock.Mock()
    census_client.geocode_client.geocode_from_str.return_value = geocoded_response
    ...
    census_client.geocode_client.geocode_from_str.assert_called()
